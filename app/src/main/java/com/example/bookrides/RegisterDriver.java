        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodGroup.equals("Select your blood group")){
                    Toast.makeText(RegisterDriver.this, "Select Blood group", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                Toast.makeText(RegisterDriver.this, "Error" + error, Toast.LENGTH_SHORT).show();
                            }
                            else {
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(RegisterDriver.this, "Data set Successfully", Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(RegisterDriver.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                if (resultUri !=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RegisterDriver.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()){
                                                                    Toast.makeText(RegisterDriver.this, "Image url added to database successfully", Toast.LENGTH_SHORT).show();
                                                                }else {
                                                                    Toast.makeText(RegisterDriver.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                    ...
                                    Intent intent = new Intent(RegisterDriver.this, Register_Vehicle.class);
